...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="橘右京"/>
		...
		<input type="hidden" name="orderShipping.receiverDistrict" value="双流区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="剑南大道 xxxxxxxxx"/>
</form>
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							...
							<div class="fr">187*****973</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">成都市双流区</div>
						<div class="adr-m" limit="30">剑南大道北三段</div>
